              ...
              <section>
                ...
                <div className="text-white/80 space-y-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>Your data is yours</strong> - We don't sell or provide your data to third parties without your consent. It's just not what we do here at XS Card. Your data is yours to share with your network.</li>
                    <li><strong>Secure Storage</strong> - Your data is protected by Enterprise grade encryption and security.</li>
                    <li><strong>Safe Sharing</strong> - Every XS Card has a unique code and web address. Those you share your information with will be able to look at your details. If they share your card with others or their company, others may be able to view your details.</li>
                  </ul>
                </div>
              </section>
